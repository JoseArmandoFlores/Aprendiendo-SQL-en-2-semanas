...
--Problema 1
	...
	create table /agenda(--Da error por un caracter invalido.
		apellido varchar(30),
		nombre varchar(20),
	...
	create table agenda(--Da error porque ya esta creada
	apellido varchar(30),
	nombre varchar(20),
	domicilio varchar(30),
	telefono varchar(11)
	...
	drop table agenda;
	drop table agenda;--Da error porque la tabla no existe.
...
--Problema 2
	...
	create table libros(--Da error porque ya esta creada
		titulo varchar(20),
		autor varchar(30),
		editorial varchar(15)
	);
	...
	drop table libros
	drop table libros--Da error porque ya se ha eliminado
...
--Problema 1
	...
	select * from agenda
	drop table agenda
	drop table agenda--Da error porque ya se ha eliminado
